//CLASE QUE USA VARIABLES CONSTANSTES para identificar el estado del juego(en programacion orientada a objetos no son recomendables usarlas)
class MaquinaEstados{
  //CONSTANTES USADAS PARA EL CAMBIO DE PANTALLA
